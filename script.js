...
const dataset = {
    "dataset": [
         ...
         },
        {
         ...
         {
        "input":"Are you a magician? Because whenever I look at you, everyone else disappears!",
        "responses":[
             {"text":"If I am a magician maybe you could wish upon a star so we get to see each other sooner ;) Let's make it a reality 😉.","score":0.9, "tags":["flirty","humor"]},
            {"text":"Hopefully that can make all of your other problems disappear! But do you know what to wish next?", "score":0.88, "tags":["flirty","humor","positive"]},
            {"text":"I might have some magic tricks, what do you say about me showing them to you privately? 😉 What did you like? 😎", "score":0.80, "tags": ["flirty","humor"]},
            {"text":"Is it magic or am I simply too stunning for anyone to compete? 😉, tell me what other magical things I have 😄 ", "score":0.79, "tags": ["casual", "flirty"]}
            ]
        },
        {
        "input":"Is your name Google? Because you've got everything I've been searching for.",
          "responses":[
                {"text":"Maybe I have more surprises in my system. Should I unlock them for you? 😉", "score": 0.92, "tags": ["flirty","humor"]},
                 {"text":"Well, if I have everything that you're looking for you might as well explore the possibilities. 😉 What is your next search for tonight? 😜", "score": 0.88, "tags": ["flirty", "humor"]},
                {"text":"That means you have finally found what your heart desired, did it work, gorgeous? 😎", "score": 0.85, "tags": ["flirty","humor"]},
                 {"text":"Hopefully that means that I am the perfect fit for you then, what do you say? 😉 Do we fit?", "score": 0.78, "tags":["casual", "flirty"]}
            ]
         },
         {
        "input": "Do you believe in love at first sight, or should I walk by again?",
        "responses": [
             {"text":"I would prefer if you did that very close to me ;) You tell me... should I do it? 😀", "score":0.94, "tags":["flirty", "humor"]},
           {"text": "Why not both? walk back into my heart so that we can know each other and we can spend time together 😉", "score": 0.89, "tags": ["flirty", "humor"]},
              {"text": "I think I do now, specially if it's with a person as stunning as you. Should I see you walk towards me? 😉", "score":0.85, "tags":["flirty", "positive"]},
                {"text":"Well, it did work on my end. I think that a second look can never be too bad. 😄 Do you like to explore?", "score":0.78,"tags":["casual", "humor"]}
            ]
          },
           {
            "input":"Are you from Tennessee? Because you're the only ten I see.",
             "responses":[
                   {"text":"That means I got a 10/10! Well I will try to prove why. But it should also work on your end! 😏 What do you think?", "score": 0.95, "tags": ["flirty","humor", "positive"]},
                   {"text": "And you, for me are over 100, now what are we waiting for to continue chatting more 😉?", "score": 0.88, "tags":["flirty", "positive", "humor"]},
                    {"text":"Did someone used math on you today? And a lot of praise? But yes, that was really smooth 😏 What should you say to that now?", "score": 0.85, "tags": ["flirty","humor"]},
                    {"text":"Are you trying to say that I am beautiful? I can see why! But tell me something different 😉 What would you say to me?", "score": 0.79, "tags":["casual", "humor"]}
                ]
         },
         {
        "input": "If you were a vegetable, you’d be a cute-cumber.",
         "responses": [
             {"text":"And if you were a fruit you'd be a fine-apple, but what do we do about all this chemistry between us? 😉", "score":0.94, "tags":["flirty", "humor"]},
             {"text":"Well maybe now I understand what was so alluring about vegetables! 😜 What fruit would you be if I had to pick one? 😏", "score": 0.90, "tags":["flirty", "humor"]},
             {"text":"You got me! Now what does a cute-cumber look like on my free time, gorgeous? 😉","score": 0.85, "tags": ["flirty","positive","humor"]},
           {"text": "Oh so, we are starting with food related compliments, I am always up for the challenge! 😉 What is next? 😎", "score": 0.77, "tags":["casual","flirty"]}
         ]
        },
         {
            "input":"Is your name WiFi? Because I'm feeling a connection.",
             "responses":[
                  {"text":"That means we have a strong signal, we should try to see where that connection leads us 😉. Let's plan something!", "score":0.94, "tags":["flirty","humor"]},
                 {"text": "It’s good that we have good signals, I cannot believe that I found you!. What else do we connect on? 😉", "score": 0.89, "tags": ["flirty","positive","humor"]},
                  {"text": "I feel the same. 😉 It looks like we can create an amazing connection! Maybe a second date would help? ", "score":0.85, "tags":["flirty", "humor"]},
                 {"text":"I can see the signal is strong on this side. Maybe if we keep trying to connect we could see how deep the connection goes 😉. What about you?", "score":0.80,"tags":["casual", "flirty"]}
                 ]
         },
        {
           "input":"Are you a parking ticket? Because you've got fine written all over you.",
            "responses":[
               {"text":"Maybe we should spend some more time so that you can analyze all of the fine print 😏?", "score": 0.92, "tags":["flirty", "humor"]},
               {"text":"Then maybe I should try and explore other beautiful features in you 😏!. But tell me what do you do when you feel fine?", "score": 0.89, "tags":["flirty","humor"]},
                 {"text": "Did someone tried to compliment my fine features? 😉 Let's see if I live up to that, maybe we can spend some time and you can be the judge 😉","score":0.85,"tags":["flirty","humor"]},
              {"text": "Did you get a parking ticket for this? Or are you ready to park by my side forever? 🤔 Let me know 😉!", "score": 0.80, "tags":["casual", "flirty","humor"]}
             ]
        },
...
const exampleButtons = document.querySelectorAll(".example-button"); // grab the example buttons
...
function handleFeedback(selectedResponse, copyButton, inputText){
    ...
    const feedbackText = document.createElement("span");
      feedbackText.classList.add("feedback-notification");
       copyButton.parentNode.appendChild(feedbackText);
    feedbackText.innerHTML =  '<svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg>';
...
function setLoadingState(loading) {
    if (loading) {
      ...
      generateBtn.textContent = "Get Rizz!";
    ...
    let matchingEntry = dataset.dataset.find(entry => entry.input === processedText);
     ...
     if (matchingEntry) {
      ...
      setLoadingState(false);
       ...
       const mlResponses = await generateResponsesWithML(processedText, rizzLevel, userProfile.rizzLevel);
...
// Event listener for example buttons to auto populate text
...
//Setdark mode toggle based on saved user preference or default false.
   if (userProfile.darkMode){
     body.classList.add("dark-mode");
       header.classList.add("dark-mode");
       textareas.forEach(textarea => textarea.classList.add("dark-mode"));
        buttons.forEach(button=> button.classList.add("dark-mode"));
        const responseOptions = document.querySelectorAll("#response-area .response-option"); // Update this
        responseOptions.forEach(option => option.classList.add("dark-mode"));
         footers.forEach(footer=> footer.classList.add("dark-mode"));
          ...
          const exampleButtons = document.querySelectorAll(".example-button") //updated to include example buttons
           exampleButtons.forEach(button=> button.classList.add("dark-mode"));
    ...
    textareas.forEach(textarea => textarea.classList.toggle("dark-mode"));
      ...
      footers.forEach(footer=> footer.classList.toggle("dark-mode"));
       selects.forEach(select=> select.classList.toggle("dark-mode"));
        const exampleButtons = document.querySelectorAll(".example-button") //updated to include example buttons
        exampleButtons.forEach(button=> button.classList.toggle("dark-mode"));
